...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1d1a8aab630980c08fd1fa0a11863a5e,en:1d1a8aab630980c08fd1fa0a11863a5e',
  ...
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || false, // 是否开启主题切换
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JOVOVICH', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, JAVA, JAVA笔记, 技术博客', // 网站关键词 英文逗号隔开
  ...
  PRISM_THEME_PREFIX_PATH: 'https://npm.elemecdn.com/prism-themes/themes/prism-one-light.min.css', // 代码块默认主题
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM_THEME_LIGHT_PATH: 'https://npm.elemecdn.com/prism-themes/themes/prism-one-light.min.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH: 'https://npm.elemecdn.com/prism-themes/themes/prism-dracula.min.css', // 深色模式主题
